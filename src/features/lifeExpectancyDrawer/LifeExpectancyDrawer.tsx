...
import { Drawer, TOption, WheelDatePicker } from '@/ui-kit';
...
export const LifeExpectancyDrawer = () => {
  ...
  const [showDeathDateBlock, setShowDeathDateBlock] = useState<boolean>(true);
  ...
  return (
    ...
    >
      <div className={s.introWrap}>
        ...
        <Select
          options={LIFE_EXPECTANCY_OPTIONS as unknown as TOption[]}
